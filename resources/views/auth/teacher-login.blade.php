...
<head>
    ...
    <title>Teacher Login - RemedialHub</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .login-icon { width: 64px; height: 64px; background: linear-gradient(135deg, #8b5cf6, #7c3aed); border-radius: 16px; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 16px; box-shadow: 0 10px 30px rgba(139,92,246,0.3); }
        ...
        .login-btn { width: 100%; padding: 14px; background: linear-gradient(135deg, #8b5cf6, #7c3aed); border: none; border-radius: 10px; color: #fff; font-size: 15px; font-weight: 600; cursor: pointer; transition: all 0.3s; font-family: 'Inter', sans-serif; }
        .login-btn:hover { transform: translateY(-1px); box-shadow: 0 10px 25px rgba(139,92,246,0.3); }
        .back-link { display: block; text-align: center; margin-top: 24px; color: #a5b4fc; text-decoration: none; font-size: 14px; }
        ...
        <div class="login-card">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-input" placeholder="teacher@example.com" required value="{{ old('email') }}">
                </div>
                <div class="form-group">
                    <label class="form-label">Password</label>
                    <input type="password" name="password" class="form-input" placeholder="Enter your password" required>
                </div>
                <button type="submit" class="login-btn"><i class="fas fa-sign-in-alt"></i> Login to Teacher Panel</button>
            </form>
